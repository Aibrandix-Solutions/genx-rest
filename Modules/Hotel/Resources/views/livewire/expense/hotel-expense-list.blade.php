<div>
    ...
    <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
        <div class="w-full mb-1">
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Hotel Expenses</h1>
            </div>
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300">
                                            {{ \Modules\Hotel\Entities\HotelExpense::DEPARTMENTS[$expense->department] ?? ucfirst($expense->department) }}
                                        </span>
                                    </td>
                                    <td class="p-4 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                        {{ $expense->vendor ?? '—' }}
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="exp_department" wire:model="department"
                            ...
                            <x-input-error for="department" class="mt-1" />
                        </div>
                        <div>
