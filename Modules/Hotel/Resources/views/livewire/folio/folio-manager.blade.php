            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-stone-100 dark:divide-gray-800">
                        ...
                        <tr wire:key="folio-charge-{{ $charge->id }}" @class([
                            ...
                            <td class="px-4 py-3.5 text-sm text-right font-semibold tabular-nums text-stone-900 dark:text-white whitespace-nowrap">
                                @if($editingChargeId === $charge->id)
                                    <div class="inline-flex items-center justify-end gap-1 max-w-full" x-data x-init="$nextTick(() => $refs.chargeAmountInput?.focus())">
                                        <input
                                            type="number"
                                            step="0.01"
                                            min="0.01"
                                            ...
                                            class="w-24 sm:w-28 rounded-lg border-blue-300 bg-white px-2 py-1 text-right text-sm font-semibold text-stone-900 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 dark:border-blue-700 dark:bg-gray-800 dark:text-white"
                                        />
                                        <button type="button" wire:click="saveEditCharge" wire:loading.attr="disabled" wire:target="saveEditCharge" class="p-1 rounded-md text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-950/30" title="@lang('app.save')">
                                        ...
                                        <button type="button" wire:click="cancelEditCharge" class="p-1 rounded-md text-stone-400 hover:text-stone-600 hover:bg-stone-100 dark:hover:bg-gray-800" title="@lang('app.cancel')">
