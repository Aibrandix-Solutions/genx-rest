<div class="border-b border-gray-200 dark:border-gray-700 mb-6">
    <nav class="-mb-px flex space-x-8" aria-label="Reports">
        ...
        <a href="{{ route('inventory.reports.item-inventory') }}" 
            wire:navigate
            class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm {{ request()->routeIs('inventory.reports.item-inventory') 
                ? 'border-skin-base text-skin-base dark:text-skin-base' 
                : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300' }}">
            {{ __('inventory::modules.reports.item_inventory.title') }}
        </a>
        <a href="{{ route('inventory.reports.transfers') }}"
            wire:navigate
            class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm {{ request()->routeIs('inventory.reports.transfers')
                ? 'border-skin-base text-skin-base dark:text-skin-base'
                : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-400 dark:hover:text-gray-300' }}">
