<div>
    <div class="space-y-6">
        ...
        <div>
            ...
            @if(!$sourceLocation)
                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center text-gray-500 dark:text-gray-400 text-sm">
                    {{ __('inventory::modules.transfers.select_source_location_first') }}
                </div>
            @else
                        ...
                        <div wire:key="transfer-item-{{ $index }}" class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <select wire:model.live="transferItems.{{ $index }}.unit_id"
                                        ...
                                        <option value="">-- {{ __('inventory::modules.transfers.unit') }} --</option>
                                        @foreach($availableUnits as $unit)
                                            <option value="{{ $unit->id }}" {{ isset($item['unit_id']) && $item['unit_id'] == $unit->id ? 'selected' : '' }}>
            ...
            @endif {{-- end @if(!$sourceLocation)/@else --}}
        </div>
