                            ...
                            @foreach($items as $index => $item)
                                <tr wire:key="purchase-item-{{ $item['_key'] ?? $index }}">
                                    ...
                                    <td class="px-4 py-2 w-40">
                                        <div class="flex gap-2">
                                            <x-input type="number" step="0.01" min="0" wire:model.live="items.{{ $index }}.discount" placeholder="{{ $item['discount'] ?? 0 }}" value="{{ $item['discount'] ?? 0 }}" class="w-full placeholder:text-gray-400 dark:placeholder:text-gray-500 text-gray-900 dark:text-gray-300" />
