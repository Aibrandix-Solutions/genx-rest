    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        ...
        <form wire:submit.prevent="recordPayment" class="space-y-6">
            ...
            <div class="flex items-center justify-end gap-2">
                <x-secondary-button type="button" wire:click="resetForm" wire:loading.attr="disabled" wire:target="recordPayment" :disabled="$isSaving">{{ trans('inventory::modules.payments.clear') }}</x-secondary-button>
