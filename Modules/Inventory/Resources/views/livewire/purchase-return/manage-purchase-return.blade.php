        ...
        <div class="p-6 bg-white dark:bg-gray-800">
            ...
            <form wire:submit.prevent="save">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        <x-label for="purchase_order_id" value="Purchase Order (Optional)" 
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Selecting a PO will auto-fill items</p>
                    </div>
