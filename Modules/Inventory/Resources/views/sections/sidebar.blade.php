...
</svg>' :active='request()->routeIs(["inventory.*"]) || request()->routeIs(["units.*", "inventory-items.*", "inventory-stocks.*", "inventory-movements.*", "recipes.*", "purchase-orders.*", "purchase-returns.*", "inventory.reports.*", "inventory-settings.*", "suppliers.*", "inventory-item-categories.*", "stock-transfers.*"])'>
