...
return [
    ...
    'menu' => [
        ...
        'locations' => 'Locations',
        'itemPurchases' => 'Inventory Item Purchases',
        'admin' => 'Admin',
    ],
    'supplier' => [
        'suppliers' => 'Suppliers',
        ...
        'linked_purchases_count' => ':count purchases',
        'paymentDetails' => 'Payment Details',
        'paymentAllocation' => 'Purchase allocation',
        'unallocatedPayment' => 'This payment is not linked to a specific purchase (advance / unallocated credit).',
        'appliedToPurchase' => 'Applied to purchase',
        'purchaseTotal' => 'Purchase total',
        'amountApplied' => 'Amount from this payment',
        'paidOnPurchase' => 'Total paid on purchase (now)',
        'dueOnPurchase' => 'Due on purchase (now)',
        'partialPayment' => 'Partial payment',
        'fullPayment' => 'Full payment',
        'paymentStatusNow' => 'Purchase status (now)',
        'confirmDeletePayment' => 'Delete payment of :amount? Supplier balance, purchase due amounts, and payment account will be restored.',
        'paymentDeleted' => 'Payment deleted successfully.',
        'viewPayment' => 'View',
        'deletePayment' => 'Delete',
        'actions' => 'Actions',
        'paymentType' => 'Payment type',
        'noPaymentAllocations' => 'No purchase allocations for this payment.',
        'allocationTotal' => 'Total',
        'recordedBy' => 'Recorded by',
        'edit_purchase' => 'Edit Purchase',
        'delete_purchase' => 'Delete Purchase',
        'select_purchase_prompt' => 'Select the purchase you want to manage. You can edit amounts and details, or delete a purchase and reverse its financial effects.',
        'select_purchase_required' => 'Please select a purchase order first.',
        'edit_selected_purchase' => 'Edit Selected Purchase',
        'delete_purchase_message' => 'This will permanently delete the selected purchase and reverse its stock, payments, and ledger entries. This action cannot be undone.',
        'search_purchase_placeholder' => 'Search by PO number, invoice number, status, or amount...',
    ...
    'stock' => [
        ...
        'viewByLocation' => 'View Stock by Location',
        'stockByLocationTitle' => 'Stock by Location',
        'totalQuantity' => 'Total Quantity',
        'noLocationsAvailable' => 'No locations available for this item.',
        'recentPurchases' => 'Recent Purchases',
        'allPurchases' => 'All Purchases',
        'viewAllPurchases' => 'View All (:count)',
        'showRecentOnly' => 'Show Recent Only',
        'noPurchasesForItem' => 'No purchases found for this item.',
    ...
    'consumption' => [
        ...
        'title' => 'Consumption',
        'subtitle' => 'Track inventory consumption across branches and menu items',
        'recordConsumption' => 'Record Consumption',
        'modalTitle' => 'Record Consumption — :name (:code)',
        'quantity' => 'Quantity',
        'available' => 'Available',
        'branch' => 'Branch',
        'selectBranch' => 'Select Branch',
        'date' => 'Date',
        'menusUsed' => 'Menus Used',
        'menusUsedPlaceholder' => 'Search and pick menus consumed by this stock',
        'searchMenus' => 'Search menus...',
        'noMenuItems' => 'No menu items found',
        'note' => 'Note',
        'notePlaceholder' => 'Optional note (max 255 characters)',
        'recorded' => 'Consumption recorded successfully',
        'quantityExceedsStock' => 'Quantity exceeds current stock. Available: :available :unit',
        'quantityMustBePositive' => 'Quantity must be greater than zero',
        'searchPlaceholder' => 'Search by item name, code, or note...',
        'allBranches' => 'All Branches',
        'allItems' => 'All Items',
        'totalConsumed' => 'Total Consumed (Qty)',
        'entries' => 'Entries',
        'uniqueItems' => 'Unique Items',
        'branchesActive' => 'Branches',
        'perItemTotals' => 'Per-Item Totals',
        'perBranchBreakdown' => 'Per-Branch Breakdown',
        'menuWiseUsage' => 'Menu-wise Usage',
        'item' => 'Item',
        'recordedBy' => 'Recorded By',
        'noEntries' => 'No consumption entries match the current filters',
        'noData' => 'No data',
        'report' => [
            'title' => 'Consumption Report',
            'tabLabel' => 'Report',
            'subtitle' => 'Per-item view of stock before consumption, consumed quantity, and stock after',
            'viewReport' => 'View Report',
            'backToConsumption' => 'Back to Consumption',
            'beforeConsumption' => 'Before Consumption',
            'consumed' => 'Consumed',
    ...
    'disposal' => [
        ...
        'title'                  => 'Disposition',
        'subtitle'               => 'Record and track inventory wastage across branches',
        'recordDisposal'         => 'Record Disposal',
        'modalTitle'             => 'Dispose — :name (:code)',
        'dispose'                => 'Dispose',
        'quantity'               => 'Quantity',
        'available'              => 'Available',
        'branch'                 => 'Branch',
        ...
        'reasonPlaceholder'      => 'e.g. Expired, spoiled, damaged... (max 255 characters)',
        'recorded'               => 'Disposal recorded successfully',
        'confirmDispose'         => 'Confirm Dispose',
        'wastageWarning'         => 'This action records wastage',
        'quantityExceedsStock'   => 'Quantity exceeds current stock. Available: :available :unit',
        'quantityMustBePositive' => 'Quantity must be greater than zero',
        'searchPlaceholder'      => 'Search by item name, code, or reason...',
        'allBranches'            => 'All Branches',
        'allItems'               => 'All Items',
        'totalDisposed'          => 'Total Disposed (Qty)',
        'totalDisposedUnit'      => 'units disposed',
        'entries'                => 'Entries',
        'uniqueItems'            => 'Unique Items',
        'branches'               => 'Branches',
        'perItemTotals'          => 'Per-Item Totals',
        ...
        'item'                   => 'Item',
        'recordedBy'             => 'Recorded By',
        'noEntries'              => 'No disposal entries match the current filters',
        'noData'                 => 'No data',
        'reportSection'          => 'Wastage / Disposition',
    ],
    'locations' => [
        'title' => 'Locations',
    ...
    'purchaseOrder' => [
        ...
        'default_date' => 'Today',
        'search_placeholder' => 'Search by purchase ID, PO number, invoice number, or supplier...',
        'all_suppliers' => 'All Suppliers',
        'search_supplier_placeholder' => 'Search supplier by name...',
        ...
        'report_subtitle' => 'Purchase orders matching the current filters',
        ...
        'cannot_edit_received' => 'You do not have permission to edit received purchases.',
        'cannot_delete_with_returns' => 'This purchase cannot be deleted because it has linked purchase returns.',
        'cannot_delete_insufficient_stock' => 'Cannot delete this purchase because there is insufficient stock to reverse item: :item.',
        'location_not_found' => 'Purchase location not found.',
        'total_below_paid' => 'The new purchase total cannot be less than the amount already paid.',
        'audit_amount_updated_note' => 'Purchase amount updated via edit.',
        'audit_deleted_note' => 'Purchase :po_number deleted and financial effects reversed.',
        'item' => 'Item',
    ...
    'reports' => [
        ...
        'tabs' => [
            ...
            'item_inventory' => 'Item Inventory Report',
        ...
        'item_inventory' => [
            ...
            'description' => 'Summary of purchases, usage, branch transfers, and wastage per inventory item.',
            'download_full' => 'Download Full Report (PDF)',
            'active_filters' => 'Active filters',
            'total_rows' => 'Total rows',
            'actions' => 'Actions',
            'view' => 'View',
            'details_title' => 'Item Activity Details',
            'close_details' => 'Close',
            'ledger' => [
                'date' => 'Date',
                'ref_no' => 'Ref No',
            ...
            'filters' => [
                ...
                'branch_hint' => 'All columns',
                'start_date' => 'Start Date',
                'end_date' => 'End Date',
                'date_hint' => 'All columns (by activity date)',
                'supplier' => 'Supplier',
                'purchase_status' => 'Purchase Status',
                'payment_status' => 'Payment Status',
                'purchases_only' => 'Purchases column only',
                'purchases_only_panel_note' => 'Purchases-only filters (supplier, purchase status, payment status) affect the Purchases column only.',
                'search_item' => 'Search Item',
                'search_item_placeholder' => 'Search by item name or item code...',
                'item_sections_hint' => 'All columns',
                'inventory_item' => 'Inventory Item',
                'activity_type' => 'Activity Type',
                'location' => 'Purchase Location',
                'location_hint' => 'All columns (source/destination on transfers)',
            ],
            'activity_types' => [
                'all' => 'All',
                'purchases' => 'Has Purchases',
                'usage' => 'Has Usage',
                'movements' => 'Has Movements',
                'wastages' => 'Has Wastages',
            ],
            'summary' => [
                'inventory_item' => 'Inventory Item',
                'purchases_column' => 'Purchases',
                'usage_column' => 'Usage',
                'movements_column' => 'Movements',
                'wastages_column' => 'Wastages',
                'empty' => '—',
                'purchases' => ':qty :unit received · :count PO lines · :subtotal subtotal',
                'usage' => ':qty :unit · :count entries',
                'movements' => 'Out: :out :unit · In: :in :unit · :count transfers',
                'wastages' => ':qty :unit · :count entries',
            ],
            'sections' => [
                'purchases' => 'Purchases',
                'purchases_desc' => 'Inventory item lines from purchase orders.',
                'usage' => 'Usage',
                'usage_desc' => 'Manual consumption records per inventory item.',
                'movements' => 'Movements (Branch Transfers)',
                'movements_desc' => 'Stock transferred out and in between branches.',
                'wastage' => 'Wastage',
                'wastage_desc' => 'Disposed or wasted inventory items.',
            ],
            'columns' => [
                'date' => 'Date',
                'po_number' => 'PO Number',
                ...
                'from_branch' => 'From Branch (Out)',
                'to_branch' => 'To Branch (In)',
                'qty_out' => 'Qty Out',
                'qty_in' => 'Qty In',
                'status' => 'Status',
                'reason' => 'Reason',
        ...
        'transfers' => [
            ...
            'description' => 'Completed inventory transfers by item, location, day, or month. Pending and in-transit transfers are excluded.',
            'types' => [
                'item' => 'Item-wise Transfer Report',
                'location' => 'Location-wise Transfer Report',
                'daily' => 'Daily Transfer Report',
                'monthly' => 'Monthly Transfer Summary',
            ],
            'summary' => [
                'total_transfers' => 'Total Transfers',
                'total_lines' => 'Total Line Items',
            ...
            'filters' => [
                ...
                'search' => 'Search',
                'search_placeholder' => 'Transfer number, item name or code...',
                'items' => 'Items',
                'all_items' => 'All items',
                'clear' => 'Clear Filters',
                'active_branch' => 'Branch',
                'completed_hint' => 'Only completed transfers are included.',
            ],
            'table' => [
                'item_title' => 'Transferred Items',
                'location_title' => 'Location-wise Transfers',
                'daily_title' => 'Daily Transfers',
                'monthly_title' => 'Monthly Transfer Summary',
                'select' => 'Select',
                ...
                'actions' => 'Actions',
                'view' => 'View Transfer',
                'empty' => 'No completed transfers found for the selected filters.',
            ],
        ],
        'item_purchases' => [
    ...
    'transfers' => [
        ...
        'print_report' => 'Print Report',
        'report_title' => 'Stock Transfers Report',
        'report_subtitle' => 'Stock transfers matching the current filters',
        'printed_by' => 'Printed by',
        'generated_at' => 'Generated at',
        'no_records' => 'No transfers found',
        'total_transfers' => 'Total Transfers',
