<div class="w-full px-4 sm:px-6 lg:px-8 py-6">
    <div class="flex items-start justify-between mb-6">
        ...
        @can('Create Department')
            <x-button type="button" wire:click="create">Add Department</x-button>
        @endcan
    </div>
    ...
    <x-dialog-modal wire:model.live="showDeleteModal" maxWidth="md">
        <x-slot name="title">Delete Department</x-slot>
        <x-slot name="content">Are you sure you want to delete this department?</x-slot>
        <x-slot name="footer">
            <div class="flex items-center gap-2">
