<div class="w-full p-4 flex flex-wrap gap-4">
    ...
    <div>
        <x-dropdown align="left">
            ...
            <x-slot name="content">
                ...
                <x-dropdown-link class="flex items-center">
                    <input id="sort-asc" type="radio" value="asc" wire:model.live='sortOrder'
                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-gray-600 focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                    <label for="sort-asc" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        Ascending
                    </label>
                </x-dropdown-link>
                <x-dropdown-link class="flex items-center">
                    <input id="sort-desc" type="radio" value="desc" wire:model.live='sortOrder'
                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-gray-600 focus:ring-gray-500 dark:focus:ring-gray-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                    <label for="sort-desc" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">
                        Descending
                    </label>
                </x-dropdown-link>
