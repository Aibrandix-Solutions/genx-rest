    ...
    <div>
        ...
        <div class="p-4 bg-white block sm:flex items-center justify-between dark:bg-gray-800 dark:border-gray-700">
            <div class="w-full mb-1">
                <div class="mb-4">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">@lang('modules.expenses.reports.outstandingPaymentReport')</h1>
                </div>
                                ...
                                @foreach ($expenses as $expense)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" wire:key='menu-item-{{ $loop->index . microtime() }}' wire:loading.class.delay='opacity-10'>
                                        ...
                                        <td
                                            class="py-2 px-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                            <span
                                                class="px-2 py-1 bg-yellow-100 text-yellow-600 rounded"> {{ $expense->payment_status }}</span>
                                        </td>
                                    </tr>
                                @endforeach
