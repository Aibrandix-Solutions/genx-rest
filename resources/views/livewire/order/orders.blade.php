        ...
        <div class="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            <div class="flex flex-wrap items-center gap-2">
                <form action="#" method="GET">
                    <div class="flex flex-wrap items-center gap-2">
                        <x-select id="dateRangeType" class="block w-fit shrink-0" wire:model="dateRangeType"
                        ...
                        <div id="date-range-picker" date-rangepicker class="inline-flex items-center shrink-0 rounded-lg border border-gray-300 bg-white shadow-sm dark:bg-gray-700 dark:border-gray-600">
                            <div class="relative w-[8.75rem]">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/>
                                    </svg>
                                </div>
                                <input id="datepicker-range-start" name="start" type="text" class="bg-transparent border-0 text-gray-900 text-sm font-medium rounded-s-lg focus:ring-2 focus:ring-blue-500 block w-full ps-10 py-2.5 pe-2 whitespace-nowrap dark:text-white dark:focus:ring-blue-500" wire:model.change='startDate' placeholder="@lang('app.selectStartDate')">
                            </div>
                            <span class="px-2 text-sm font-medium text-gray-500 dark:text-gray-400 shrink-0">@lang('app.to')</span>
                            <div class="relative w-[8.75rem]">
                                <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                    <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/>
                                ...
                                <input id="datepicker-range-end" name="end" type="text" class="bg-transparent border-0 text-gray-900 text-sm font-medium rounded-e-lg focus:ring-2 focus:ring-blue-500 block w-full ps-10 py-2.5 pe-2 whitespace-nowrap dark:text-white dark:focus:ring-blue-500" wire:model.live='endDate' placeholder="@lang('app.selectEndDate')">
                            </div>
                        </div>
                    </div>
                </form>

                <x-select class="text-sm w-44 shrink-0" wire:model.live.debounce.250ms='filterOrders'>
                ...
                <x-select class="text-sm w-44 shrink-0" wire:model.live.debounce.250ms='filterWaiter'>
            ...
            <div class="flex items-center gap-3 shrink-0">
                <div class="relative w-full sm:w-48">
                    ...
                    <input type="text" wire:model.live.debounce.300ms="searchOrderId" class="block w-full py-2.5 ps-10 pe-3 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ __('placeholders.searchOrdersById') }}">
                </div>

                @if(user_can('Create Order'))
                    <x-primary-link href="{{ route('pos.index') }}" class="shrink-0 whitespace-nowrap inline-flex items-center">
