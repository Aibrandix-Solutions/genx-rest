@php
    $posFilterTabActive = 'bg-gray-900 text-white dark:bg-white dark:text-gray-900 max-md:ring-2 max-md:ring-skin-base max-md:ring-offset-1 max-md:dark:ring-offset-gray-900';
