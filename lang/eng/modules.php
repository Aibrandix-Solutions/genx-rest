...
return [
    'menu' => [
        ...
        'selectBranchesHelp' => 'Select the branches where this should be created. The same menu will be provisioned in each selected branch.',
        'menuCategoryMultiBranchHelp' => 'Menu and category lists show your current branch. If they are not in another selected branch yet, they will be created there automatically when you save.',
        'editMenuItemBranchesHelp' => 'Select which branches should offer this item. Uncheck a branch to remove it there when you save.',
        'provisionAdditionalBranches' => 'Also create in these branches',
        'provisionAdditionalBranchesHelp' => 'Select additional branches that do not have this record yet. Existing branches are not changed.',
        'linkedBranches' => 'Available in branches',
        'kitchenAssignmentHelp' => 'Choose which kitchens in each selected branch should prepare this item.',
        'noKitchensInBranch' => 'No active kitchens found for this branch.',
        'provisionedToBranches' => 'Created in :count branch(es).',
        'item' => 'Item(s)',
        ...
        'multiKitchenNote' => 'This item will be routed to multiple kitchens',
        'multiKitchenBadge' => 'Multi-Kitchen',
        'multiKitchenItemBadge' => 'MK',
        'availableInMultipleKitchens' => 'Available in multiple kitchens',
        'handledByAnotherKitchen' => 'Handled by another kitchen',
        'preparingInKitchen' => 'In: :kitchen',
        'markAllItemsReady' => 'All Items Ready',
        ...
        'mergeModeDescription' => 'Add or update listed items and variations. Keeps any existing variations not mentioned.',
        'replaceMode' => 'Replace Mode',
        'replaceModeDescription' => 'Sync exactly. Deletes variations for imported items that are not in the file.',
        'importingVariations' => 'Importing variations...',
        'type' => 'Type',
    ...
    'order' => [
        ...
        'billed' => 'Billed',
        'paid' => 'Paid',
        'folio_settled' => 'Settled via Hotel',
        'billed_to_room' => 'Billed to Room',
        'roomCharge' => 'Room Charge',
        'folioSettledLocked' => 'This order was settled at hotel checkout and can no longer be edited.',
    ...
    'combo' => [
        ...
        'comboPackSettings' => 'Combo Pack Settings',
        'comboPackSettingsDescription' => 'Manage your combo packs here. Group multiple menu items together with a discounted price to offer value deals to your customers.',
        'createComboPack' => 'Create Combo Pack',
        'editComboPack' => 'Edit Combo Pack',
        'comboPackName' => 'Combo Pack Name',
        ...
        'saveComboPack' => 'Save Combo Pack',
        'cancel' => 'Cancel',
        'delete' => 'Delete',
        'edit' => 'Edit',
        'noComboPacks' => 'No combo packs found',
        'selectAtLeastOneItem' => 'Please select at least one menu item',
        'itemsInCombo' => 'Items in Combo',
        'save' => 'Save',
        'deleteComboPack' => 'Delete Combo Pack',
        'deleteConfirmation' => 'Are you sure you want to delete this combo pack?',
        'comboPackDeleted' => 'Combo pack deleted successfully',
        'comboPackSaved' => 'Combo pack saved successfully',
        'comboPackUpdated' => 'Combo pack updated successfully',
        'errorSavingComboPack' => 'Error saving combo pack',
        'errorDeletingComboPack' => 'Error deleting combo pack',
        'errorUpdatingComboPack' => 'Error updating combo pack',
        'comboAdded' => 'Combo Added',
        'itemsAddedFromCombo' => 'Items added from combo',
        'comboDiscount' => 'Combo Discount',
        'regularPriceStrikethrough' => 'Regular Price',
        'saveAmount' => 'Save',
        'percentOff' => 'off',
    ...
    'customer' => [
        ...
        'pay' => 'Pay',
        'pay_for_customer' => 'Make Payment For',
        'ledger' => 'Ledger',
        'ledger_for_customer' => 'Ledger For',
        'ledger_title' => 'Customer Ledger',
        'sales' => 'Sales',
        'sales_for_customer' => 'Sales For',
        'select_orders_to_pay' => 'Please select orders to pay',
    ...
    'reward' => [
        ...
        'earningPointsSettings' => 'Earning Points Settings',
        'redeemPointsSettings' => 'Redeem Points Settings',
        'enableRewardPoint' => 'Enable Reward Point',
        'rewardPointDisplayName' => 'Reward Point Display Name',
        'rewardPointDisplayNameHelp' => 'The name displayed to customers (e.g., "Reward Points", "Loyalty Points")',
        'amountSpendForUnitPoint' => 'Amount Spend for Unit Point',
        'amountSpendForUnitPointHelp' => 'Amount customer needs to spend to earn 1 point (e.g., 1.00 means 1 currency unit = 1 point)',
        'minimumOrderTotalToEarn' => 'Minimum Order Total to Earn',
        'minimumOrderTotalToEarnHelp' => 'Minimum order total required for customer to earn points',
        'maximumPointsPerOrder' => 'Maximum Points Per Order',
        'maximumPointsPerOrderHelp' => 'Maximum points that can be earned in a single order (leave empty for unlimited)',
        'redeemAmountPerUnitPoint' => 'Redeem Amount Per Unit Point',
        'redeemAmountPerUnitPointHelp' => 'Discount amount per point when redeeming (e.g., 1.00 means 1 point = 1 currency unit discount)',
        'minimumOrderTotalToRedeem' => 'Minimum Order Total to Redeem',
        'minimumOrderTotalToRedeemHelp' => 'Minimum order total required for customer to redeem points',
        'minimumRedeemPoint' => 'Minimum Redeem Point',
        'minimumRedeemPointHelp' => 'Minimum points required for redemption (leave empty for no minimum)',
        'maximumRedeemPointPerOrder' => 'Maximum Redeem Point Per Order',
        'maximumRedeemPointPerOrderHelp' => 'Maximum points that can be redeemed in a single order (leave empty for unlimited)',
        'rewardPointExpiryPeriod' => 'Reward Point Expiry Period',
        'rewardPointExpiryPeriodHelp' => 'Points will expire after this period (0 = no expiry). Select month or year.',
        'month' => 'Month',
        'months' => 'Months',
        'year' => 'Year',
        'years' => 'Years',
        ...
        'adjustPointsTitle' => 'Adjust Customer Reward Points',
        'adjustPointsAmount' => 'Points Amount',
        'adjustPointsAmountHelp' => 'Positive number to add points, negative to deduct',
        'adjustPointsDescription' => 'Description',
    ...
    'settings' => [
        ...
        'rewardPointsSettings' => 'Reward Points Settings',
        'rewardPointsHelp' => 'Configure loyalty reward points system for your customers. Customers earn points on orders and can redeem them for discounts.',
        ...
        'paymentAccountSettingsDescription' => 'Configure default payment accounts for each payment method. When a payment is made using a specific method, it will automatically be assigned to the configured account.',
        'defaultPaymentAccount' => 'Default Payment Account',
        'paymentMethod' => 'Payment Method',
        'noPaymentAccounts' => 'No Payment Accounts Available',
        'noPaymentAccountsDescription' => 'Please create payment accounts in the Inventory module before configuring default accounts.',
        'none' => 'None',
        ...
        'disableTableLockTimeout' => 'Disable Time-based Lockout',
        'disableTableLockTimeoutDescription' => 'When enabled, table locks will not expire automatically by time.',
    ...
    'report' => [
        ...
        'roomChargeOrdersReportMessage' => 'Track restaurant orders billed to guest rooms and their settlement status',
        'roomChargeOrderDetails' => 'Room Charge Order Details',
        'dateAndTime' => 'Date & Time',
        'room' => 'Room',
        'guest' => 'Guest',
        'restaurantBranch' => 'Restaurant Branch',
        'hotelBranch' => 'Hotel Branch',
        'orderedItems' => 'Ordered Items',
        'unitPrice' => 'Unit Price',
        'grandTotal' => 'Grand Total',
        'settlementDetails' => 'Settlement Details',
        'settlementStatus' => 'Settlement Status',
        'settlementOutstanding' => 'Outstanding',
        'settlementPartiallyPaid' => 'Partially Paid',
        'settlementPaid' => 'Paid',
        'allSettlementStatuses' => 'All Statuses',
